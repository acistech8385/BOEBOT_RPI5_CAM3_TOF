...
/**
 * FullHardwareTest - Menu Option 13: Run all hardware tests in sequence.
 *
 ...
 *   3. PCA9685 init
 *   4. Gripper servo (CH0)
 *   5. Camera Module 3 still capture (CAM0)
 *   6. ArduCam ToF SDK detection (CAM1)
 *   7. Wheel servos (optional - skipped unless WHEELS_LIFTED confirmed)
 *
 * Note: ToF live preview (11) and ToF capture (12) are NOT run automatically
 * in the full test because preview requires a display and capture is run interactively.
 *
...
public class FullHardwareTest {
    ...
    public static void run(AppLogger logger, BotConfig config,
        ...
        System.out.println();
        System.out.println("============================================");
        System.out.println("  Test 13: Full Safe Hardware Test");
        System.out.println("============================================");
        ...
        logger.logSeparator();
        logger.log("TEST 13: Full Safe Hardware Test - Begin");
        ...
        System.out.println();
        System.out.println("[FULL TEST] Running Test 8: Camera Module 3 Still Capture...");
        cam3Ok = CameraModule3Test.run(logger, config);
        pause();

        // ---- Test 10: ArduCam ToF SDK detection ----
        System.out.println();
        System.out.println("[FULL TEST] Running Test 10: ArduCam ToF SDK Detection...");
        ...
        System.out.println("  Skip safely by not typing WHEELS_LIFTED.");
        System.out.println();
        ...
        printResult("Test 8   Camera Module 3 Still    ", cam3Ok);
        printResult("Test 10  ArduCam ToF SDK Detection", tofOk);
        System.out.println("  Test 11  ToF Live Preview          : use option 11");
        System.out.println("  Test 12  ToF Capture/Save          : use option 12");
        System.out.println("============================================");
        ...
        logger.log("  ToF SDK        : " + (tofOk      ? "PASS" : "FAIL"));
        if (wheelSkip) {
